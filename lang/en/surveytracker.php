...
$string['edit:expiry'] = 'Expiry Date (12 a.m.)';
...
$string['form:expiry'] = '«Expiry Date»';
$string['form:expiry_help'] = 'Add a expiry date. All sruveys will be sorted by expiry date and will disapear at the expiry date (12 a.m.).';
